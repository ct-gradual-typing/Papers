...
\item
  ...
  it suffices to show that $[[G |- ? ~ A2]]$, but this easily follows.
...
\item 
  ...
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  We know by assumption that $[[G |- A2 ~ A1]]$ and hence $[[G' |- A2 ~ A1]]$ by Lemma~\ref{lemma:type_cons_ctx_pre}.  
