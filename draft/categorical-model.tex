...
\begin{lemma}[Casting Morphisms to $[[?]]$]
  ...
  $\cat{C}$.  Then there exists casting morphisms from $[[A]]$ to
  $[[?]]$ and vice versa that make $[[A]]$ a retract of $[[?]]$.
\end{lemma}
\begin{proof}
...
morphisms $[[lbox A]] : [[A --> ?]]$ and $[[lunbox A]] : [[? --> A]]$.
Please see
...
\begin{corollary}
  ...
  \begin{enumerate}[i.]
  \item If $[[A1 -> B1 ~ A2 -> B2]]$, then there are casting
    morphisms $c_1 : [[A2 --> A1]]$ and $c_2 : [[B1 --> B2]]$,
    and $c_3 : [[A1 --> A2]]$ and $c_4 : [[B2 --> B1]]$.
    
  \item If $[[A1 x B1 ~ A2 x B2]]$, then there are casting
    morphisms $c_1 : [[A1 --> A2]]$ and $c_2 : [[B1 --> B2]]$,
    and $c_3 : [[A2 --> A1]]$ and $c_4 : [[B2 --> B1]]$.
  \end{enumerate}
\end{corollary}
\begin{proof}
