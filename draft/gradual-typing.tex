...
\renewcommand{\SLGradydrulesuccName}[0]{\text{succ}}
\renewcommand{\SLGradydrulepairName}[0]{\times}
\renewcommand{\SLGradydrulefstName}[0]{\times_{e_1}}
\renewcommand{\SLGradydrulesndName}[0]{\times_{e_2}}
\renewcommand{\SLGradydrulefstCName}[0]{\times_{e_1}}
\renewcommand{\SLGradydrulesndCName}[0]{\times_{e_2}}
\renewcommand{\SLGradydrulelamName}[0]{\to}
\renewcommand{\SLGradydrulesndUName}[0]{\times^?_{e_2}}
\renewcommand{\SLGradydrulefstUName}[0]{\times^?_{e_1}}
\renewcommand{\SLGradydrulesuccUName}[0]{\text{succ}^?}
\renewcommand{\SLGradydruleappCName}[0]{\to_e}
\renewcommand{\SLGradydruleappUName}[0]{\to_e^?}
\begin{figure}  
  \begin{mdframed}
    \small
    \begin{mathpar}
      ...
      \SLGradydrulefstC{} \and
      \SLGradydrulesndC{} \and
      \SLGradydrulelam{} \and
      \SLGradydruleappC{} \and      
      \SLGradydrulesuccU{} \and
      \SLGradydrulefstU{} \and
      \SLGradydrulesndU{} \and
      \SLGradydruleappU{}       
    \end{mathpar}
  \end{mdframed}
...
\renewcommand{\SLGradydrulerdAXXcastAName}[0]{\text{value-cast}}
\renewcommand{\SLGradydrulerdAXXcastNatName}[0]{[[Nat]]\text{-cast}}
\renewcommand{\SLGradydrulerdAXXcastArrowName}[0]{\to\hspace{-2.5px}\text{-cast}}
