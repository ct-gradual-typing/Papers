...
\input{poly-grady-inc}
\renewcommand{\RightTirName}{\text}
\renewcommand{\PGradydrule}[4][]{{\displaystyle\frac{\begin{array}{l}#2\end{array}}{#3}\,\Gradydrulename{#4}}}
\renewcommand{\PGradydrulename}[1]{#1}
...
\section{Extending Grady with Impredicative Polymorphism}
\label{sec:extending_grady_with_impredicative_polymorphism}
\input{poly-grady-ott}
% section extending_grady_with_impredicative_polymorphism (end)
