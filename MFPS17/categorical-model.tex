...
number object.  This is a simplification a traditional natural number
object; see Lambek and Scott~\cite{Lambek:1988} for an introduction to
  ...
  such that the following diagrams commute:
       ...
       \begin{array}{lll}
         ...
         \qtriangle|amm|<1000,500>[
           ...
           [[Y x Nat]]`
           X;
           \langle \id_Y, \diamond_Y;\mathsf{z} \rangle`
           f`
           \Case_{Y,X} \langle f,g \rangle]

         \ptriangle(1000,0)|amm|/<-`->`->/<1000,500>[
           [[Y x Nat]]`
           [[Y x Nat]]`
           [[X]];
           \id_Y \times \mathsf{succ}`
           \Case_{Y,X} \langle f,g \rangle`          
           g]
         \efig                               
       \end{array}
...
%% One major difference between NRNOs and the more traditional natural
%% number objects is that in the definition of the latter $g$ is defined
%% by well-founded recursion.  However, NRNOs do not allow this, but in
