...
%%  \\ Computer and Information Sciences\\ Augusta University\\ Augusta, USA \\ \href{mailto:harley.eades@gmail.com} and \href{mailto:mitownsend@augusta.edu}

%% \thanks[ALL]{Thanks: Both authors where supported by the National
%%   Science Foundation CRII CISE Research Initiation grant,
%%   ``CRII:SHF: A New Foundation for Attack Trees Based on Monoidal
%%   Categories``, under Grant No. 1565557.}
%% \thanks[myemail]{Email:\href{mailto:heades@augusta.edu}
%%   {\texttt{\normalshape heades@augusta.edu}}}
%% \thanks[coemail]{Email: \href{mailto:mitownsend@augusta.edu}
