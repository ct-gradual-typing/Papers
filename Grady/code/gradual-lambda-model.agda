...
error₄ {A}{B}{Γ} t = proof
                       ...
                       ≡M⟨ {!!} ⟩
                       ⟨ (triv Γ) ∘ curry (proj2 ∘ unboxT B) , ⟨ ((triv Γ) ∘ curry (proj2 ∘ (boxT A))) , t ⟩ ⟩ ∘ ((id _) xM app) ∘ app
                       ≡M⟨ {!!} ⟩
                       ⟨ curry (((triv Γ) xM (id _)) ∘ proj2 ∘ unboxT B) , ⟨ ((triv Γ) ∘ curry (proj2 ∘ (boxT A))) , t ⟩ ⟩ ∘ ((id _) xM app) ∘ app
                       ≡M⟨ {!!} ⟩
                       ⟨ curry (((triv Γ) xM (id _)) ∘ proj2 ∘ unboxT B) , ⟨ (curry (((triv Γ) xM (id _)) ∘ proj2 ∘ (boxT A))) , t ⟩ ⟩ ∘ ((id _) xM app) ∘ app
                       ≡M⟨ {!!} ⟩
                       ⟨ curry (proj2 ∘ unboxT B) , ⟨ (curry (proj2 ∘ (boxT A))) , t ⟩ ⟩ ∘ ((id _) xM app) ∘ app
                       ≡M⟨ {!!} ⟩
